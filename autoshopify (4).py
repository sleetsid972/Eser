...
def shopify_checker():
    try:
        ...
        # OPTIMISED: submit to shared event loop instead of creating one per request
...
#   gunicorn -k gevent --workers 4 --bind 0.0.0.0:5000 "Autoshopify (1):app"
# or with threads:
#   gunicorn --workers 4 --threads 4 --bind 0.0.0.0:5000 "Autoshopify (1):app"
